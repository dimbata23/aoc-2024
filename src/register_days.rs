...
pub fn register_days() -> DayMap {
    ...
    use day23;
    days.insert("day23", day23::run);
    use day24;
    days.insert("day24", day24::run);
    use day12;
    ...
    use day25;
    days.insert("day25", day25::run);
    use day22;
    days.insert("day22", day22::run);
    use day04;
